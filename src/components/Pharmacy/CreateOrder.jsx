...
const CreatePurchaseOrder = () => {
  ...
  const handleSaveOrder = async (e) => {
    ...
    try {
      const newOrder = {
        stockistName: selectedStockist, // Use selectedStockist instead of stockistValue
        date,
        items: tableData,
        status: "ongoing",
        setStockistNames, // Include setStockistNames in the order data
      };
    ...
    <>
      ...
      >
        ...
        <div className="stocklist-cpo">
          ...
          <div className="stocklist-cpo1">
            <label className="cr-order-l" htmlFor="Manufacturer">
              Manufacturer Name
            </label>
            <input
              className="createOrderInput"
          ...
          <div className="stocklist-cpo1">
            <label className="cr-order-l" htmlFor="date">
              Order Date
            </label>
            <input
              className="createOrderInput"
        ...
        {isEditFormOpen && (
          <div className="popup-edit-form">
            <div className="edit-form">
              ...
              <label className="cr-order-l" htmlFor="editUnitStrips">
                Unit/Strips:
              </label>
              <input
                type="text"
              ...
              />
              <label className="cr-order-l" htmlFor="editNoOfStrips">
                No. of Strips:
              </label>
              <input
                type="text"
